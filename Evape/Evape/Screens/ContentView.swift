                ...
                ScrollView(Axis.Set.horizontal, showsIndicators: false) {
                    HStack {
                        Button(action: {
                            ...
                            for i in 0...3 {
                                self.newShapes.append(Generation(number: self.shapes.last!.number + 1, color: [self.shapes.last!.color[0] + .random(in: -10.0...10.0), self.shapes.last!.color[1] + .random(in: -10.0...10.0), self.shapes.last!.color[2] + .random(in: -10.0...10.0)], cornerRadius: self.shapes.last!.cornerRadius + .random(in: -5.0...5.0), rotationCount: self.shapes.last!.rotationCount + .random(in: -5...5), opacity: self.shapes.last!.opacity + .random(in: -0.1...0.1), degree: self.shapes.last!.degree + .random(in: -20.0...20.0), isSelectable: true, placement: i + 1))
                            }
